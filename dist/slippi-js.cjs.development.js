...
const stages = {
  ...
  [exports.Stage.TARGET_TEST_MARIO]: {
    id: exports.Stage.TARGET_TEST_MARIO,
  ...
  [exports.Stage.TARGET_TEST_DR_MARIO]: {
    id: exports.Stage.TARGET_TEST_DR_MARIO,
    name: "Target Test (Dr. Mario)",
  },
  [exports.Stage.TARGET_TEST_FALCO]: {
    id: exports.Stage.TARGET_TEST_FALCO,
    name: "Target Test (Falco)",
  },
  [exports.Stage.TARGET_TEST_FOX]: {
    id: exports.Stage.TARGET_TEST_FOX,
  ...
  [exports.Stage.TARGET_TEST_KIRBY]: {
    id: exports.Stage.TARGET_TEST_KIRBY,
    name: "Target Test (Kirby)",
  },
  [exports.Stage.TARGET_TEST_BOWSER]: {
    id: exports.Stage.TARGET_TEST_BOWSER,
    name: "Target Test (Bowser)",
  },
  [exports.Stage.TARGET_TEST_LINK]: {
    id: exports.Stage.TARGET_TEST_LINK,
    name: "Target Test (Link)",
  },
  [exports.Stage.TARGET_TEST_LUIGI]: {
    id: exports.Stage.TARGET_TEST_LUIGI,
    name: "Target Test (Luigi)",
  },
  [exports.Stage.TARGET_TEST_MARTH]: {
    id: exports.Stage.TARGET_TEST_MARTH,
    name: "Target Test (Marth)",
  },
  [exports.Stage.TARGET_TEST_MEWTWO]: {
    id: exports.Stage.TARGET_TEST_MEWTWO,
    name: "Target Test (Mewtwo)",
  },
  [exports.Stage.TARGET_TEST_NESS]: {
    id: exports.Stage.TARGET_TEST_NESS,
    name: "Target Test (Ness)",
  },
  [exports.Stage.TARGET_TEST_PEACH]: {
    id: exports.Stage.TARGET_TEST_PEACH,
    name: "Target Test (Peach)",
  },
  [exports.Stage.TARGET_TEST_PICHU]: {
    id: exports.Stage.TARGET_TEST_PICHU,
    name: "Target Test (Pichu)",
  },
  [exports.Stage.TARGET_TEST_PIKACHU]: {
    id: exports.Stage.TARGET_TEST_PIKACHU,
  ...
  [exports.Stage.TARGET_TEST_SAMUS]: {
    id: exports.Stage.TARGET_TEST_SAMUS,
    name: "Target Test (Samus)",
  },
  [exports.Stage.TARGET_TEST_SHEIK]: {
    id: exports.Stage.TARGET_TEST_SHEIK,
    name: "Target Test (Sheik)",
  },
  [exports.Stage.TARGET_TEST_YOSHI]: {
    id: exports.Stage.TARGET_TEST_YOSHI,
    name: "Target Test (Yoshi)",
  },
  [exports.Stage.TARGET_TEST_ZELDA]: {
    id: exports.Stage.TARGET_TEST_ZELDA,
  ...
  [exports.Stage.TARGET_TEST_ROY]: {
    id: exports.Stage.TARGET_TEST_ROY,
    name: "Target Test (Roy)",
  },
  [exports.Stage.TARGET_TEST_GANONDORF]: {
    id: exports.Stage.TARGET_TEST_GANONDORF,
    name: "Target Test (Ganondorf)",
  },
  [exports.Stage.HOME_RUN_CONTEST]: {
    id: exports.Stage.HOME_RUN_CONTEST,
...
function isDamaged(state) {
  return (
    (state >= exports.State.DAMAGE_START && state <= exports.State.DAMAGE_END) || state === exports.State.DAMAGE_FALL
  );
}
...
function isCommandGrabbed(state) {
  return (
    ((state >= exports.State.COMMAND_GRAB_RANGE1_START && state <= exports.State.COMMAND_GRAB_RANGE1_END) ||
...
function didStartGrabSuccess(currentAnimation, previousAnimation) {
  return (
    previousAnimation === exports.State.GRAB &&
    currentAnimation <= exports.State.GRAB_WAIT &&
    currentAnimation > exports.State.GRAB
  );
}
...
function didStartGrabFail(currentAnimation, previousAnimation) {
  return (
    previousAnimation === exports.State.GRAB &&
    (currentAnimation > exports.State.GRAB_WAIT || currentAnimation < exports.State.GRAB)
  );
}
...
function handleComboCompute(frames, state, indices, frame, combos) {
  ...
  if (opntIsDamaged || opntIsGrabbed || opntIsCommandGrabbed) {
    ...
    if (!state.combo) {
      ...
      state.combo = {
        ...
        endFrame: null,
        startPercent: prevOpponentFrame
          ? (_prevOpponentFrame$pe = prevOpponentFrame.percent) != null
            ? _prevOpponentFrame$pe
            : 0
          : 0,
  ...
  if (shouldTerminate) {
    ...
    state.combo.endPercent = prevOpponentFrame
      ? (_prevOpponentFrame$pe2 = prevOpponentFrame.percent) != null
        ? _prevOpponentFrame$pe2
        : 0
      : 0;
...
class ConversionComputer extends events.EventEmitter {
  ...
  _populateConversionTypes() {
    ...
    const sortedConversions = lodash.orderBy(groupedConversions, (conversions) =>
      lodash.get(conversions, [0, "startFrame"]),
...
function handleConversionCompute(frames, state, indices, frame, conversions) {
  ...
  if (!opntDidLoseStock) {
    ...
    state.conversion.currentPercent =
      (_opponentFrame$percen2 = opponentFrame.percent) != null ? _opponentFrame$percen2 : 0;
  }
  ...
  if (shouldTerminate) {
    ...
    state.conversion.endPercent = prevOpponentFrame
      ? (_prevOpponentFrame$pe2 = prevOpponentFrame.percent) != null
        ? _prevOpponentFrame$pe2
        : 0
      : 0;
...
function getOpeningRatio(conversionsByPlayerByOpening, playerIndex, opponentIndices, type) {
  ...
  const opponentOpenings = lodash.flatten(
    opponentIndices.map((opponentIndex) => lodash.get(conversionsByPlayerByOpening, [opponentIndex, type]) || []),
  );
...
function getBeneficialTradeRatio(conversionsByPlayerByOpening, playerIndex, opponentIndices) {
  ...
  const opponentTrades = lodash.flatten(
    opponentIndices.map((opponentIndex) => lodash.get(conversionsByPlayerByOpening, [opponentIndex, "trade"]) || []),
  );
    ...
    const connection = reconnect(
      ...
      (client) => {
        ...
        const handshakeMsgOut = consoleComms.genHandshakeOut(
          ...
          (_this$connDetails$cli = this.connDetails.clientToken) != null ? _this$connDetails$cli : 0,
          this.isRealtime,
        );
...
class DolphinConnection extends events.EventEmitter {
  ...
  async connect(ip, port) {
    ...
    this.ipAddress = ip;
    this.port = port;
    const enet = await Promise.resolve().then(function () {
    ...
    this.peer.on("message", (packet) => {
      ...
      switch (message.type) {
        ...
        case exports.DolphinMessageType.GAME_EVENT: {
          const { payload } = message; //TODO: remove after game start and end messages have been in stable Ishii for a bit
  ...
  _onCommand(data) {
    ...
    switch (command) {
      ...
      case exports.Command.POST_FRAME_UPDATE:
        ...
        const player = {
          ...prevPlayer,
          characterUsage: { ...characterUsage, [internalCharacterId]: curCharFrames + 1 },
        };
...
class SlpParser extends events.EventEmitter {
  ...
  getPlayableFrameCount() {
    ...
    return this.latestFrameIndex < exports.Frames.FIRST_PLAYABLE
      ? 0
  ...
  _handleItemUpdate(payload) {
    ...
    const currentFrameNumber = payload.frame;
    const items =
      (_this$frames$currentF =
        (_this$frames$currentF2 = this.frames[currentFrameNumber]) == null ? void 0 : _this$frames$currentF2.items) !=
      null
        ? _this$frames$currentF
        : [];
